...
export class DriverProfileComponent implements OnInit {
  ...
  onSubmit(){       
    ...
    let driver = new DriverClass(this.Username,this.Email,this.FullName,this.Role,this.SSN,this.Password,this.ConfirmPassword,this.Password,this.Gender,this.DriveType,this.ContactNumber,this.LocationId,this.CarId);
